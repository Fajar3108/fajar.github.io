...
const About = ({ profile }) => {
    return (
        <div id="about" className="pb-7 border-b-2">
            ...
            <a className="px-6 py-3 bg-blue-600 text-white transition-all text-sm hover:bg-blue-900 mt-3 inline-block" href="https://google.com" target="_blank" rel="noreferrer">
